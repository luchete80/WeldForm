...
inline void Domain::SolveChgOrderUpdate (double tf, double dt, double dtOut, char const * TheFileKey, size_t maxidx) {
	std::cout << "\n--------------Solving---------------------------------------------------------------" << std::endl;
...
// inline void Domain::SolveChgOrderUpdateLeapfrog (double tf, double dt, double dtOut, char const * TheFileKey, size_t maxidx) {
	// std::cout << "\n--------------Solving---------------------------------------------------------------" << std::endl;
  ...
  // cout << "Main Loop"<<endl;
    ...
    // if (isfirst ){ //
      // #pragma omp parallel for schedule (static) num_threads(Nproc)
      // for (size_t i=0; i<Particles.Size(); i++){
        // Particles[i]->v = Particles[i]->v - Particles[i]->a*dt/2.;
      // }      
