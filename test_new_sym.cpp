...
void UserAcc(SPH::Domain & domi)
{
  ...
  // }
  domi.trimesh[0]->SetVel(Vec3_t(0.0,0.,0.));
...
int main(int argc, char **argv) try
{
  ...
  double cyl_zmax = L/2. + dx*0.6 -1.e-3; //If new meshing  
	...
	mesh.AxisPlaneMesh(2,true,Vec3_t(-0.2,-0.2, -dx),Vec3_t(0.2,0.2,-dx),15);
  ...
  dom.sqrt_h_a = 0.005;
  dom.SolveDiffUpdateLeapfrog(/*tf*/0.0505,/*dt*/timestep,/*dtOut*/1.e-6 ,"test06",1000);
