...
************************************************************************************/
#define	WELDING_SPEED	0.066393 	// SON (150-15)/122s m/min
#define ARC_RADIUS		0.0075
#define WELD_LENGTH		0.15		//This include 2 * radiuos
#define THICKNESS		0.006
#define HEAT_EFF		0.65
#define WELD_EGY		116900. 	//ES LA TOTAL (SIN SIMETRIA)
...
//    	dom.Solve(/*tf*/0.01,/*dt*/timestep,/*dtOut*/0.001,"test06",999);
		...
		dom.ThermalSolve(/*tf*/600.1,/*dt*/timestep,/*dtOut*/1.0,"test06",999);
